...
public class NotiFicationUtil {
	...
	public static void showNotification(Context context,String musicName)
	{
        ...
        // 定义Notification的各种属性   
		notification=new Notification(R.drawable.me,   
                "JMemo", System.currentTimeMillis()); 
        ...
        CharSequence contentTitle ="JMemo"; // 通知栏标题   
        CharSequence contentText ="正在播放  "+musicName; // 通知栏内容   
        Intent notificationIntent =new Intent(context, JMemoActivity.class); // 点击该通知后要跳转的Activity   
